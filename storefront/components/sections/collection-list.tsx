...
function CollectionCard({
  ...
  return (
    <LocalizedLink
      className="group relative flex aspect-3/4 h-auto w-[88vw] max-w-[453px] min-w-[320px] flex-1 cursor-pointer rounded-lg"
      href={cta?.link}
      prefetch
    >
      {image ? (
        <SanityImage
          className="aspect-3/4 h-auto w-[88vw] max-w-[453px] min-w-[320px] rounded-lg object-cover object-center"
          data={image}
        />
      ) : (
      ...
      {cta && (
        <div className="bottom-lg absolute left-1/2 flex -translate-x-1/2 items-center justify-center">
          <div className="px-2xl relative flex h-[80px] w-fit items-center justify-center">
            <svg
            ...
            >
              <path
                className="fill-background group-hover:fill-accent transition-all duration-300"
            ...
            <Body
              className="group-hover:text-background relative z-10 text-center whitespace-nowrap transition-all duration-300"
              desktopSize="4xl"
              mobileSize="3xl"
            >
              {cta.label}
